...
#%% Functions (Preprocessing functions from Niels R Lorenzen)
...
# Input folder containing CWA files and output folder
input_folder = r"C:\Users\johan\Desktop\stanford_cwa_clean\Controls"
#input_folder = r"C:\Users\johan\Desktop\stanford_cwa_clean\iRBD"
output_folder = r"C:\Users\johan\Desktop\data_preprocessed\Controls"
#output_folder = r"C:\Users\johan\Desktop\data_preprocessed\iRBD"

# Define nighttime window
start_hour = 21
end_hour = 9
...
for fname in os.listdir(input_folder):
    ...
    output_df, all_info = preprocess_actigraphy_df(
        ...
        scale_by_force=False, # disabled
        standardize_axes=False, # disabled
        verbose=False )

    output_df.index = pd.to_datetime(output_df.index)

    # Split each output file into nights (21:00 to 09:00 next day)
    ...
    # For each night with <=50% missing data, write output
